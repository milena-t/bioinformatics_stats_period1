...
As discussed above, some samples will have type-I-error when the experiment is conducted often enough, for this reason the analysis needs to be corrected for multiple testing, the type I error does not change with a higher sample size.\par
\begin{lstlisting}
P_value <- 1:(100)
for(i in 1:100){
