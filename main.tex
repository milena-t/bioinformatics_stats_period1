...
Not controlling the FWER on 10 tests gives a 40\% error rate. schould be lower! This can be corrected by using $\frac{a}{m}$ instead of $\alpha$, which gives $$1-(1-\alpha)^{\alpha/m} \; = \; 0.4$$
